...
public class NewsArrayAdapter extends ArrayAdapter<News> {
    ...
    public NewsArrayAdapter(Context context, ArrayList<News> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textviewDescription.setText(item.getBriefDescription());
        ...
        aq.id(R.id.imageNews).image(item.getImg(), true, true, 200,0);
